...
// クラス別選択ボックスに並ぶ名前を画像に合わせました
const PURE_CLASS_LIST = [
  "Sクラス", "Aクラス", "Bクラス", "Cクラス", "Dクラス", "Eクラス"
];
...
export default function Competition({ onBack }: CompetitionProps) {
  ...
  // クラス別画面を開いたときに最初に選ばれるのを「Sクラス」にします
