...
// クラス（級・段）ごとの、1〜10番の選技データ（カンマエラーを完璧に修正！）
const TOURNAMENT_TRICKS: Record<string, string[]> = {
  "10級~6級": ["大皿", "小皿", "中皿", "ろうそく", "とめけん", "（なし）", "（なし）", "（なし）", "（なし）", "（なし）"],
  "5級~2級": ["とめけん", "飛行機", "ふりけん", "日本一周", "世界一周", "灯台", "けん先すべり", "地球まわし", "さか落とし", "うぐいす"],
  "1級、準初段": ["世界一周", "灯台", "けん先すべり", "地球まわし", "さか落とし", "宇宙一周", "うぐいす", "はねけん", "一回転飛行機", "極意"],
  "初段、二段": ["灯台", "けん先すべり", "地球まわし", "さか落とし", "宇宙一周", "うぐいす", "はねけん", "一回転飛行機", "一回転灯台", "レジ"],
  "三段、4段": ["さか落とし", "宇宙一周", "うぐいす", "はねけん", "一回転飛行機", "一回転灯台", "すべり止め極意", "うぐいす渡り", "ちどり", "つるし"],
  "5段以上": ["さか落とし", "宇宙一周", "うぐいす", "はねけん", "一回転飛行機", "一回転灯台", "すべり止め極意", "うぐいす渡り", "ちどり", "つるし"]
};
